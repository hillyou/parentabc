...
--inital admin user
INSERT INTO parentabc.memberuser (`USERNAME`, `PASSWD`, `CREATE_DATE`, `UPDATE_DATE`, `POINTS`, `MOBILE`, `ADDRESS`, `STATUS`, `EMAIL`, `VERSION`, `UNIONID`, `OPENID`, `SEX`, `LANG`, `CITY`, `PROVINCE`, `COUNTRY`, `NICKNAME`, `HEADIMGURL`, `SUBSCRIBE`) 
	VALUES ('admin', 'admin', '2016-11-19 12:14:41.111', '2016-11-19 12:14:41.945', 50, '1333333333', '上海', 1, 'admin@parent.com', 1, '', NULL, '1', 'zh', '上海', '上海', '中国', '管理员', NULL, 1);
