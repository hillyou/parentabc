...
--inital admin user
INSERT INTO MEMBERUSER (`USERNAME`, `PASSWD`, `CREATE_DATE`, `UPDATE_DATE`, `POINTS`, `MOBILE`, `ADDRESS`, `STATUS`, `EMAIL`, `VERSION`, `UNIONID`, `OPENID`, `SEX`, `LANG`, `CITY`, `PROVINCE`, `COUNTRY`, `NICKNAME`, `HEADIMGURL`, `SUBSCRIBE`) 
	VALUES ('guest', 'guest', '2016-11-19 12:14:41.111', '2016-11-19 12:14:41.945', 50, '1333333333', '上海', 1, 'guest@parentabc.com', 1, '', NULL, '1', 'zh', '上海', '上海', '中国', '豆妈', NULL, 1);
